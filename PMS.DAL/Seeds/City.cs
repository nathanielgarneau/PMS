...
namespace PMS.DAL.Seeds
{
    public class City : ISeed
    {
        ...
        private Xam.DAL.Model.City[] GetCities(CodeFirstModel context)
        {
            var cities = new List<Xam.DAL.Model.City>();
            var i = 1;
            foreach (var city in CanadianCities.Select(kvp => new Xam.DAL.Model.City
            {
                Id = i,
                Name = kvp.Key,
