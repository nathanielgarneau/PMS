...
namespace PMS.DAL.Migrations
{
    public partial class V00 : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                {
                    ...
                    Street = c.String(),
                    PostalCode = c.String(false),
                    City_Id = c.Int(false),
                    Country_Id = c.Int(false),
                    Province_Id = c.Int(false)
                })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    IdentificationNumber = c.String(false, 50),
                    OtherIdentificationNumber = c.String(maxLength: 50),
                    Address_Id = c.Int(false),
                    IdentificationType_Id = c.Int(false),
            ...
            CreateTable(
                ...
                c => new
                {
                    Id = c.Int(false, true),
                    Name = c.String(false, 80),
                    Description = c.String(false, 255),
                    Year = c.Int(false),
                    Colour_Id = c.Int(false),
                    ProductType_Id = c.Int(false)
                })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                {
                    Id = c.Int(false, true),
                    PurchaseCost = c.Double(false),
                    EstimatedValueLow = c.Double(),
                    EstimatedValueHigh = c.Double(),
                    SaleableDate = c.DateTime(false),
                    Client_Id = c.Int(false)
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Clients", t => t.Client_Id)
            ...
            CreateTable(
                ...
                {
                    Id = c.Int(false, true),
                    Username = c.String(false, 50),
                    Pin = c.Int(false),
                    Password = c.String(false, 20)
                })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Pawns", t => t.Pawn_Id, true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Notes", t => t.Note_Id, true)
                .ForeignKey("dbo.Pawns", t => t.Pawn_Id, true)
                .Index(t => t.Note_Id)
                .Index(t => t.Pawn_Id);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Locations", t => t.Location_Id, true)
                .ForeignKey("dbo.Pawns", t => t.Pawn_Id, true)
            ...
            CreateTable(
                ...
                {
                    Location_Id = c.Int(false),
                    Purchase_Id = c.Int(false)
                })
                .PrimaryKey(t => new {t.Location_Id, t.Purchase_Id})
                .ForeignKey("dbo.Locations", t => t.Location_Id, true)
                .ForeignKey("dbo.Purchases", t => t.Purchase_Id, true)
                .Index(t => t.Location_Id)
                .Index(t => t.Purchase_Id);
            ...
            CreateTable(
                ...
                c => new
                {
                    Condition_Id = c.Int(false),
                    Product_Id = c.Int(false)
                })
                .PrimaryKey(t => new {t.Condition_Id, t.Product_Id})
                .ForeignKey("dbo.Conditions", t => t.Condition_Id, true)
                .ForeignKey("dbo.Products", t => t.Product_Id, true)
        ...
        {
            DropForeignKey("dbo.UserSetting", "User_Id", "dbo.Users");
            ...
            DropIndex("dbo.UserSetting", new[] {"User_Id"});
