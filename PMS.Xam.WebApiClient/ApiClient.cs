...
namespace PMS.Xam.WebApiClient
{
    public static class ApiClient
    {
        ...
        public static Condition<ConditionViewModel, int> Condition =
            new Condition<ConditionViewModel, int>(UriAddresses.Condition);

        public static Country<CountryViewModel, int> Country = new Country<CountryViewModel, int>(UriAddresses.Country);

        public static Facility<FacilityViewModel, int> Facility =
            new Facility<FacilityViewModel, int>(UriAddresses.Facility);

        public static IdentificationType<IdentificationTypeViewModel, int> IdentificationType =
            new IdentificationType<IdentificationTypeViewModel, int>(UriAddresses.IdentificationType);

        public static Location<LocationViewModel, int> Location =
            new Location<LocationViewModel, int>(UriAddresses.Location);
        ...
        public static PaymentType<PaymentTypeViewModel, int> PaymentType =
            new PaymentType<PaymentTypeViewModel, int>(UriAddresses.PaymentType);

        public static Product<ProductViewModel, int> Product = new Product<ProductViewModel, int>(UriAddresses.Product);

        public static ProductType<ProductTypeViewModel, int> ProductType =
            new ProductType<ProductTypeViewModel, int>(UriAddresses.ProductType);

        public static Province<ProvinceViewModel, int> Province =
            new Province<ProvinceViewModel, int>(UriAddresses.Province);

        public static Purchase<PurchaseViewModel, int> Purchase =
            new Purchase<PurchaseViewModel, int>(UriAddresses.Purchase);
        ...
        public static UserSettings<UserSettingViewModel, int> UserSetting =
            new UserSettings<UserSettingViewModel, int>(UriAddresses.UserSettings);
    }
}